 ...
 */
final class Version20231223213412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_id VARCHAR(255) NOT NULL, fullname VARCHAR(255) DEFAULT NULL, companyname VARCHAR(255) DEFAULT NULL, amount VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, province VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, lighne_order LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', status VARCHAR(255) DEFAULT NULL, source_update VARCHAR(255) DEFAULT NULL, user_id VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL, date_update DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
