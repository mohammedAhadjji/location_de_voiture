 ...
 */
final class Version20231119173046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP lighne_order');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD lighne_order LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }
}
